...
F.CODE MONSTERPUNTCODE, A.NAME NAAM, A.CODE LABNUMMER, TO_DATE(A.SAMPLINGDATE,'DD-MM-YY') SAMPLINGDATE, B.CODE TESTCODE, B.RUNNR, B.STATUS TESTSTATUS, C.ELEMENTCODE, C.RAWRESULT RESULTAAT, C.ROUNDRESULT RESULTAAT_AFGEROND, C.REFMESSAGE, C.REFCONCLUSION, F.ID MEETPUNT_ID, TO_DATE(C.MEASUREDATE, 'DD-MM-YY') MEASUREDATE, G.CODE SOORTWATER, J.HOEDANIGHEID HOEDNHD, A.ID SAMPLE_ID, B.ID SAMPLE_TEST_ID, C.ID SAMPLE_RESULT_ID
