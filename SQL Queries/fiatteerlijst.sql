SELECT AA.OPMERKING SAMPLE_OPMERKING, AA.SAMPLE_ID, AA.LABNUMMER, TO_DATE(AA.MONSTERNAMEDATUM, 'DD-MM-YY') MONSTERNAMEDATUM, AA.OMSCHRIJVING, AA.MONSTERPUNTCODE, AA.HOEDNHD, AA.SOORTWATER, AA.STATUS, AB.CODE KLANT, AA.FIATGROEP, AA.SMPL_PRIO, 'd' ||LIMS.F_WORKDAYS (TO_CHAR(SYSDATE, 'DD-MM-YYYY' ), TO_CHAR(AA.PRIOFINISHDATE, 'DD-MM-YYYY' )) WORKDAY, TO_DATE(AA.PRIOFINISHDATE, 'DD-MM-YY') PRIOFINISHDATE 
